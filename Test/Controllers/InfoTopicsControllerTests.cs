...
//        [Fact]
//        public async void GetInfoTopicsTest_NotFound()
//        {
//            // Arrange
//            var mockRepo = new Mock<IInfoTopicBLL>();
...
//            Assert.Equal("Ingen emner ble funnet", notFoundResult.Value);
//        }
...
//            Assert.Equal("Emne objekt mangler", badRequestResult.Value);
//        }
...
//            var infotopicDTO = InfoTopicObject.TestInfoTopicDTO();
//            var mockRepo = new Mock<IInfoTopicBLL>();
//            mockRepo.Setup(repo => repo.AddDTO(infotopic)).Returns(infotopicDTO);

//            // Act
//            var result = mockRepo.Object.AddDTO(infotopic);

//            // Assert
//            var returnValue = Assert.IsType<InfoTopicDTO>(result);
//            Assert.Equal(id, returnValue.Id);
//        }
...
//            // Arrange
//            var mockRepo = new Mock<IInfoTopicBLL>();
//            mockRepo.Setup(repo => repo.AddDTO(null)).Returns((InfoTopicDTO)null);

        ...
        public static void Initialize(DBContext context)
        {
            ...
            var comments = new Comment[]
            {
                ...
                new Comment{Content="Dette skal være det første svaret til posten under Toppidrett - > Trening",
                    Date=DateTime.UtcNow,UserId=6,PostId=6},
